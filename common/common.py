...
def default_settings():
    return default_settings_matt()

def default_settings_matt():
    settings = default_settings_pifire()
    #Inherit default settings, but override these:
    settings['outpins'] = {
        "auger": 21,
        "fan": 20,
        "igniter": 16,
    ...
    settings['cycle_data']['u_min'] = 0.01
    settings['globals']['shutdown_timer'] = 600
    settings['history_page']['minutes'] = 45
    settings['safety']['maxtemp'] = 650
    return settings
